...
class MainApp(App):
    ...
    def game_over(self):
        self.root.ids.bird.pos = (20, (self.root.height - 104) / 2.0)
        for pipe in self.pipes:
    ...
    def start_game(self):
        ...
        for i in range(num_pipes):
            pipe = Pipe()
            pipe.pipe_center = randint(104 + 100, self.root.height - 100)
            pipe.size_hint = (None, None)
            pipe.pos = (Window.width + i*distance_between_pipes, 104)
            pipe.size = (61, self.root.height - 104)
